        ...
        <Content>
          ...
          { currentEdition == "2023_Winter"&&
            <Collapsible trigger="Editor's Note">
              ...
              <p>While we have you daydreaming about the good old days of friendship, we also urge you to check out a short story on sinister dreams and a singular experience of an unconventional winter break. Saving some of the best for last, the Op-Eds in this edition are an eclectic read, ranging from some questions about social media that are sure to get your gears whirring and an animated discussion on why there's a global shortage of silicon chips to an absurdly marvellous discourse on putting clowns on the moon!</p>
              <p>With the change of the seasons, we&rsquo;ve decided to rename our editions to be named after - you guessed it - the seasons! Without further ado, with much love, we present to you our Winter 2023 Edition.</p> 
            </Collapsible>
          }

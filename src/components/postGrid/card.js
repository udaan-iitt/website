    ...
    <Wrapper>
      <a href="https://your-url" class="github-corner" aria-label="View source on GitHub">
        ...
        <filter id="strokeGlow" y="-10" x="-10" width="250" height="150">
          ...
          <polygon points="246.35 0 255.45 29.25 286 29.25 261.3 47.45 270.4 76.7 246.35 58.5 221 76.7 230.1 47.45 206.045 29.25 235.95 29.25"  class="octo-body" filter="url(#strokeGlow)"/>
          {/* class="octo-arm" */}
...
const Wrapper = styled.div`
  ...
  .github-corner{
    fill:#151513; color:#fff; position: absolute; top: 0; border: 0; right: 0; z-index:99;
  }
  svg polygon {
    fill: #ffc60b;
    color: #ffc60b;
